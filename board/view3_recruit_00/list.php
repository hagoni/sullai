...
<div class="tab_conts">
    <div class="tab_cont01 tab_cont">
        <p class="stitle">(주)전한에서<br><em>열정가득한 인재를 기다립니다.</em></p>
        <p class="text">(주)전한은 글로벌 외식문화기업으로<br class="br_m">함께 성장해 나갈 <br class="br_768">창의적이고 <br class="br_m">열정적인 인재를 모집합니다.</p>
        <div class="img_area bg"></div>
        <div class="m_img_area"><img src="<?=$skin_path?>/img/bnr_img.jpg" alt="" class="w100"></div>
        <div class="process cmn_layer rel">
            ...
            <ul class="t_center">
                ...
                <li>
                    <div class="text_area">
                        ...
                        <p class="text"><a href="#none" target="_blank" class="pop_open">이미지 참고</a></p>
                    </div>
                </li>
            </ul>
            <div class="recruit_pop">
                <div class="img rel">
<?
$jmp_sql = "select * from ".TABLE_LEFT."jmp_01 where view3_use = 1 limit 1";
$jmp_res = mysql_query($jmp_sql);
$jmp_lst = mysql_fetch_assoc($jmp_res);
$jmp_img = explode("||",$jmp_lst['view3_file']);
?>
                    <img src="<?=$root?>/upload/jmp_01<?=$jmp_img[2]?>" alt="" class="w100">
        ...
        ?>
                        <li>
                            <a href="<?=$path_view?>">
                                ...
                                <p class="ad_comp">
                                    <span class="ellipsis">강강술래 <?=$list['view3_special_01']?></span>
                                </p>
...
$('.pop_open').click(function(e) {
    TweenLite.to('.recruit_pop', 0.5, {display: 'block', opacity: 1});
    e.preventDefault();
});
$('.pop_close').click(function(e) {
    TweenLite.to('.recruit_pop', 0.5, {display: 'none', opacity: 0});
    e.preventDefault();
});
</script>
