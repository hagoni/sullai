...
<div id="boardWrap">
	<div class="inquiry_wrap">
		<form class="inquiry_form pc_inquiry" method="post" action="<?=BOARD?>/index.php?<?=$path_action?>" enctype="multipart/form-data" accept-charset="<?=SET?>">
				...
				<table summary="상담자 정보 입력사항" class="inquiry_table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<select class="" name="special_01" id="iqr_special_01" required>
		...
		<form class="inquiry_form mobile_inquiry" method="post" action="<?=BOARD?>/index.php?<?=$path_action?>" enctype="multipart/form-data" accept-charset="<?=SET?>">
			<input type="hidden" name="drop" value="drop||privacy_agree||board||pw||skin||url||inquiry_action||x||y">
			<input type="hidden" name="board" value="<?=$board?>">
			<input type="hidden" name="sca" value="<?=$view3_sca?>">
			<input type="hidden" name="inquiry_action" value="ok">
