...
// $skip_sub_intro = false;
// if(!$_SESSION['before_group_idx'])$_SESSION['before_group_idx']=0;
// if($_SESSION['before_group_idx']==$group_list['view3_idx'])$skip_sub_intro=true;
// $_SESSION['before_group_idx']=$group_list['view3_idx'];
...
$store_view_link = "/html/store_view.html";
?>
<?if($gnb_index == 1 || $gnb_index == 4 || $gnb_index == 5 || $gnb_index == 6){?>
	<!-- sub_visual start -->
	<div class="sub<?=$gnb_index?>_visual sub_visual" data-sub-offset="1">
		<div class="sub_visual_bg bg"></div>
		<div class="dp_t">
			<div class="va_m">
				<p class="sub_title t_center"><?=html_entity_decode($group_list['view3_title_02'])?></p>
			</div>
		</div>
	</div>
	<!-- //sub_visual end -->
<?} elseif($gnb_index == 3 && $minor_index == 2){?>
	<!-- sub_visual start -->
	<div class="sub<?=$gnb_index?>_visual<?=$minor_index?> sub_visual">
		<div class="sub_visual_bg bg"></div>
		<div class="dp_t">
			<div class="va_m">
				<p class="sub_title t_center"><?=$board_list['view3_title_02']?></p>
				<p class="sub_text t_center"><?=html_entity_decode($board_list['view3_special_01'])?></p>
				<a href="http://www.sullaimall.com/" target="_blank" class="lyr2_link cmn_link">술래몰 바로가기<span class="cmn_arr"><img src="<?=$root?>/img/page/store/arr.png" alt=""></span></a>
			</div>
		</div>
	</div>
	<!-- //sub_visual end -->
<?} else{
	if (URL_PATH != $store_view_link) {?>
		<!-- sub_visual start -->
		<div class="sub<?=$gnb_index?>_visual<?=$minor_index?> sub_visual" data-sub-offset="1">
			<div class="sub_visual_bg bg"></div>
			<div class="dp_t">
				<div class="va_m">
					<p class="sub_title t_center"><?=$board_list['view3_title_02']?></p>
    ...
    <div class="sub_content" id="content">
		<?if (URL_PATH != $store_view_link) {?>
			<div class="page_title_area t_center">
				<p class="page_title"><?=html_entity_decode($board_list['view3_title_02'])?></p>
